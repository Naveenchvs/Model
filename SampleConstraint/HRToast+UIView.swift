...
// activity
let HRToastActivityWidth  :  CGFloat  = 110.0
let HRToastActivityHeight :  CGFloat  = 110.0
...
extension UIView {
    ...
    func makeToastActivity(position pos: AnyObject, message msg: String = "") {
        ...
        activityView.backgroundColor = UIColor.gray //UIColor.darkGray.withAlphaComponent(HRToastOpacity)
